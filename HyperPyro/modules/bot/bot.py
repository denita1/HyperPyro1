...
from HyperPyro.split.data import Data
from HyperPyro.split.inline import cb_wrapper, paginate_help
from HyperPyro import ids as users
...
async def on_plug_in_cb(_, callback_query: CallbackQuery):
    ...
    this_command += "© [SUPPORT](https://t.me/HyperSupportQ"
    bttn = [
